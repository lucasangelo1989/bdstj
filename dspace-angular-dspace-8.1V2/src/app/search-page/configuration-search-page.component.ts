...
import { ThemedSearchSettingsComponent } from '../shared/search/search-settings/themed-search-settings.component'; // ✅ IMPORTANTE
...
@Component({
  ...
  standalone: true,
  imports: [NgIf, NgTemplateOutlet, PageWithSidebarComponent, ViewModeSwitchComponent, ThemedSearchResultsComponent, ThemedSearchSidebarComponent, ThemedSearchFormComponent, SearchLabelsComponent, AsyncPipe, TranslateModule, ThemedSearchSettingsComponent],
})
